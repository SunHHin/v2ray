_get_latest_version() {
	v2ray_repos_url="https://ghproxy.com/https://api.github.com/repos/v2fly/v2ray-core/releases/latest?v=$RANDOM"
...
_download_v2ray_file() {
	...
	v2ray_download_link="https://ghproxy.com/https://github.com/v2fly/v2ray-core/releases/download/$v2ray_latest_ver/v2ray-linux-${v2ray_bit}.zip"
